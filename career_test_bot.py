...
class Database:
    def __init__(self, db_name=os.getenv("DB_PATH_CAREER")):
...
keyboard_q2 = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="До 18")], [KeyboardButton(text="18–25")], [KeyboardButton(text="26–35")],
              [KeyboardButton(text="36+")]], resize_keyboard=True)
keyboard_q3 = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Высокие зарплаты")], [KeyboardButton(text="Интерес к технологиям")],
              [KeyboardButton(text="Удалённая работа")], [KeyboardButton(text="Перспективы роста")]],
    resize_keyboard=True)
keyboard_q4 = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Программирование")], [KeyboardButton(text="Разработка интерфейсов (UI)")],
...
keyboard_q5 = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Docker, Kubernetes")], [KeyboardButton(text="React, Vue.js")],
              [KeyboardButton(text="Python, Django")], [KeyboardButton(text="SQL, MongoDB")],
              [KeyboardButton(text="Flutter, Swift")]], resize_keyboard=True)
keyboard_q6 = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Python")], [KeyboardButton(text="JavaScript")], [KeyboardButton(text="Java")],
              [KeyboardButton(text="C++")], [KeyboardButton(text="Go")]], resize_keyboard=True)
keyboard_q7 = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text="Менее 1 часа")], [KeyboardButton(text="1–3 часа")],
                                            [KeyboardButton(text="3–5 часов")],
                                            [KeyboardButton(text="Больше 5 часов")]], resize_keyboard=True)
keyboard_q8 = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Нет, я новичок")], [KeyboardButton(text="Базовые знания (курсы)")],
              [KeyboardButton(text="Есть опыт программирования")], [KeyboardButton(text="Работал в IT")]],
    resize_keyboard=True)
keyboard_q9 = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Начальный (A1–A2)")], [KeyboardButton(text="Средний (B1–B2)")],
              [KeyboardButton(text="Продвинутый (C1–C2)")], [KeyboardButton(text="Не знаю английский")]],
    resize_keyboard=True)
keyboard_q10 = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="В команде разработки")], [KeyboardButton(text="В аналитической компании")],
              [KeyboardButton(text="В сфере безопасности")], [KeyboardButton(text="В стартапе")],
              [KeyboardButton(text="В крупной IT-компании")]], resize_keyboard=True)
keyboard_q11 = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Оптимизация систем")], [KeyboardButton(text="Разработка UI")],
              [KeyboardButton(text="Анализ данных")], [KeyboardButton(text="Обеспечение безопасности")]],
    resize_keyboard=True)
keyboard_q12 = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text="Работать в команде над большими проектами")],
...
def get_specialty_details(specialty):
    details = {
        "Frontend-разработчик (Junior)": {"demand": "Высокая",
                                          "plan": "1. HTML/CSS — 1 мес.\n2. JavaScript — 2 мес.\n3. React — 2 мес."},
        "Frontend-разработчик (Middle)": {"demand": "Высокая",
                                          "plan": "1. Углубить React/Vue — 3 мес.\n2. TypeScript — 2 мес.\n3. Оптимизация UI — 2 мес."},
        "Python-разработчик (Junior)": {"demand": "Высокая",
                                        "plan": "1. Основы Python — 2 мес.\n2. Работа с данными — 1 мес.\n3. Веб (Flask) — 2 мес."},
        "Backend-разработчик (Middle)": {"demand": "Высокая",
                                         "plan": "1. Django/Flask — 3 мес.\n2. API (REST) — 2 мес.\n3. Базы данных — 2 мес."},
        "Аналитик данных (Junior)": {"demand": "Высокая",
                                     "plan": "1. Python — 2 мес.\n2. SQL — 1 мес.\n3. Визуализация данных — 2 мес."},
        "Data Scientist (Middle)": {"demand": "Очень высокая",
                                    "plan": "1. ML (scikit-learn) — 3 мес.\n2. Статистика — 2 мес.\n3. Deep Learning — 3 мес."},
        "Специалист по кибербезопасности (Junior)": {"demand": "Средняя",
                                                     "plan": "1. Основы сетей — 2 мес.\n2. Безопасность — 2 мес.\n3. Инструменты (Wireshark) — 1 мес."},
        "Специалист по кибербезопасности (Middle)": {"demand": "Высокая",
                                                     "plan": "1. Углубить сети — 2 мес.\n2. Pentesting — 3 мес.\n3. Сертификаты (CEH) — 3 мес."},
        "UX/UI-дизайнер (Junior)": {"demand": "Средняя",
                                    "plan": "1. Основы дизайна — 1 мес.\n2. Figma — 2 мес.\n3. Прототипы — 2 мес."},
        "DevOps Engineer (Junior)": {"demand": "Высокая",
                                     "plan": "1. Linux — 2 мес.\n2. Docker — 2 мес.\n3. CI/CD — 2 мес."},
        "DevOps Engineer (Middle)": {"demand": "Очень высокая",
                                     "plan": "1. Kubernetes — 3 мес.\n2. Облака (AWS) — 3 мес.\n3. Автоматизация — 2 мес."},
        "Mobile Developer (Junior)": {"demand": "Средняя",
                                      "plan": "1. Java/Kotlin — 2 мес.\n2. Android Studio — 2 мес.\n3. Простые приложения — 1 мес."},
        "Mobile Developer (Middle)": {"demand": "Высокая",
                                      "plan": "1. Flutter/Swift — 3 мес.\n2. API интеграция — 2 мес.\n3. Оптимизация — 2 мес."},
    }
...
async def start_test(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "📟 **IT Тест**\n\nЯ задам тебе несколько вопросов, чтобы подобрать IT-специальность.\n\n💡 Вопрос 1: Как тебя зовут?",
        reply_markup=None)
...
async def answer_q12(message: types.Message, state: FSMContext):
    ...
    if user_data["q4"] == "Программирование":
        if user_data["q6"] == "JavaScript" and user_data["q5"] == "React, Vue.js":
            if user_data["q8"] in ["Нет, я новичок", "Базовые знания (курсы)"] and user_data[
                "q3"] == "Удалённая работа":
                specialty = "Frontend-разработчик (Junior)"
                description = "Создаёшь интерфейсы сайтов, идеально для удалённой работы."
            elif user_data["q8"] in ["Есть опыт программирования", "Работал в IT"] and user_data["q2"] in ["26–35",
                                                                                                           "36+"]:
        ...
        if user_data["q6"] == "Python" and user_data["q7"] in ["3–5 часов", "Больше 5 часов"] and user_data[
            "q2"] == "До 18":
